  ...
  return (
    <>
      <section>
        ...
        <Paragraph>
          An obsessive generalist, my interests range from investing, to software development, to
          math and science, to logic and philosophy. A perpetual student in all of my worthwhile
          fields, I obsess over gathering information that brings clarity to my worldview. See my
          Dendron <Anchor href={constants.dendronTechUrl}>second-brain</Anchor>.
        </Paragraph>
        ...
        <Paragraph>
          If you think we should be in touch, then I look forward to talking with you! The best way
